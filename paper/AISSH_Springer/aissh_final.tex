...
%% this folder. Content is the narratively-restructured version (see
%% aissh_springer_manuscript_v2.tex for full rationale): guard-bear's safety-
%% transfer failure leads, consumer-hardware deployability second, and the
%% LoRA configuration-ordering crossover is framed as an unexpected discovery
%% made during development rather than the primary motivation. Bibliography
%% uses BibTeX (aissh_final.bib) instead of a manually-numbered list.
